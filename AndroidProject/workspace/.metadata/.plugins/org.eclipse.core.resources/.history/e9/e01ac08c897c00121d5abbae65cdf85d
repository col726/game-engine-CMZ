...
{    
      ...
      {
      c = getContentPane();
      setBounds(50, 50, 470, 495);
      setBackground(new Color(204, 204, 204));
      setDefaultCloseOperation(EXIT_ON_CLOSE);
      setTitle("Figure Frames");
      setResizable(false);
      c.setLayout(null);     
      pnlMain.setBounds(4, 4, 460, 460);
      ...
      private ImageIcon knightBlack = new ImageIcon(System.getProperty("user.dir") + "/images/Sample.jpg");

      private ImageIcon knightWhite = new ImageIcon(System.getProperty("user.dir") + "/images/KnightWhite.png");

      private ImageIcon kingBlack = new ImageIcon(System.getProperty("user.dir") + "/images/java3.png");

      private ImageIcon kingWhite = new ImageIcon(System.getProperty("user.dir") + "/images/java3.png");

      private ImageIcon queenBlack = new ImageIcon(System.getProperty("user.dir") + "/images/java2.png");

      private ImageIcon queenWhite = new ImageIcon(System.getProperty("user.dir") + "/images/java1.png");

      private ImageIcon pawnBlack = new ImageIcon(System.getProperty("user.dir") + "/images/bg.png");

      private ImageIcon pawnWhite = new ImageIcon(System.getProperty("user.dir") + "/images/GoFish-background.jpg");
